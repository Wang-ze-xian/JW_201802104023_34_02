package com.example.demo.bysj.basic.department;
...
public class DepartmentControl extends HttpServlet {
    ...
    @RequestMapping(value = "/departmentControl.ctl", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "/departmentControl.ctl", method = RequestMethod.DELETE)
    @ResponseBody
    ...
    //49.234.210.182:8080/bysj2324/departmentControl.ctl
    @RequestMapping(value = "/departmentControl.ctl", method = RequestMethod.PUT)
    @ResponseBody
    ...
    //49.234.210.182:8080/bysj2324/departmentControl.ctl
    @RequestMapping(value = "/departmentControl.ctl", method = RequestMethod.GET)
    @ResponseBody
