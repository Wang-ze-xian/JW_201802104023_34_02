package com.example.demo.bysj.basic.user;
...
public class UserControl extends HttpServlet {
    ...
    @RequestMapping(value = "/userControl.ctl", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/userControl.ctl", method = RequestMethod.PUT)
    @ResponseBody
    ...
    @RequestMapping(value = "/userControl.ctl", method = RequestMethod.DELETE)
    @ResponseBody
    ...
    @RequestMapping(value = "/userControl.ctl", method = RequestMethod.POST)
    @ResponseBody
