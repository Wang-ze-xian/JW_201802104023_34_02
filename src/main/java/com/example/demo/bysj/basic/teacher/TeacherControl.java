package com.example.demo.bysj.basic.teacher;
...
public class TeacherControl extends HttpServlet {
    ...
    @RequestMapping(value = "/teacherControl.ctl", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "/teacherControl.ctl", method = RequestMethod.DELETE)
    @ResponseBody
    ...
    //49.234.210.182:8080/bysj2324/teacherControl.ctl
    @RequestMapping(value = "/teacherControl.ctl", method = RequestMethod.PUT)
    @ResponseBody
    ...
    //49.234.210.182:8080/bysj2324/teacherControl.ctl
    @RequestMapping(value = "/teacherControl.ctl", method = RequestMethod.GET)
    @ResponseBody
