package com.example.demo.bysj.basic.school;
...
public class SchoolControl extends HttpServlet {
    ...
    @RequestMapping(value = "/schoolControl.ctl", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "/schoolControl.ctl", method = RequestMethod.DELETE)
    @ResponseBody
    ...
    //49.234.210.182:8080/bysj2324/schoolControl.ctl
    @RequestMapping(value = "/schoolControl.ctl", method = RequestMethod.PUT)
    @ResponseBody
    ...
    //49.234.210.182:8080/bysj2324/schoolControl.ctl
    @RequestMapping(value = "/schoolControl.ctl", method = RequestMethod.GET)
    @ResponseBody
